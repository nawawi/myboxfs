...
#define CISAVI2VTBL \
  ...
  HRESULT (SOPHOS_STDCALL_PUBLIC_PTR GetVirusEngineVersion)(void *object, U32 *pVersion, LPOLESTR pVersionString, U32 StringLength, SYSTEMTIME *pVdataDate, U32 *pNumberOfDetectableViruses, U32 *pReserved, REFIID DetailsIID, void **ppIDEList); \
