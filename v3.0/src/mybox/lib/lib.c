...
void log_action(char *type, char *msg) {
	xsystem("/bin/php -f /service/init/initconf.init mybox_slog \"%s\" \"%s\"",type,msg);
}
...
void fixup_argv(char **argv,char *name) {
        ...
        while(*++argv) memset(*argv, 0, strlen(*argv));
}

/*void print_banner(void) {
	printf("+=============================================================================+\n");
	printf("| MYBOX FIREWALL SYSTEM (c) Tracenetwork Corporation Sdn. Bhd.                |\n");
	printf("|                           http://www.tracenetwork.com.my                    |\n");
	printf("+=============================================================================+\n");
}*/
void print_banner(void) {
	printf("      _                                                             \n");
	printf("  __/ /_ _____ ___  _____ ____                                      \n");
	printf(" /_  __/ ___ / __ `/  ___/ _                                        \n");
	printf("  / /_ / /  / /_/ /  /__/   __/                                     \n");
	printf("  \\__/ _/   ___,/____/____/ Network.                               \n");
	printf("                                                                    \n");
	printf("                               R E D E F I N I N G  S E C U R I T Y\n");
	printf("====================================================================\n");
	printf(" MYBOX INTERNET SECURITY (c) Tracenetwork Corporation Sdn. Bhd.    \n");
	printf("                             http://www.tracenetworkcorporation.com\n");
	printf("====================================================================\n");
}
