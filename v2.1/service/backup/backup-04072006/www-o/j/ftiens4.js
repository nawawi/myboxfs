...
{ 
  ...
  this.nodeImg = 0;
  this.isLastNode = 0;
  this.iconSrc = ICONPATH + "expanded_folder.png";
  this.iconSrcClosed = ICONPATH + "closed_folder.png";
...
{ 
  ...
  if (this.level>0) 
    if (this.isLastNode) //the last child in the children array 
      ...
      leftSide = leftSide + "<td valign=top background=" + ICONPATH + "branch.png>" + auxEv + "<img name='nodeIcon" + this.id + "' id='nodeIcon" + this.id + "' src='" + nodeName + "' width=16 height=22 border=0></a></td>"
...
{ 
  ...
  { 
	if (USEFRAMES)
	  docW = docW + "<a href='" + this.hreference + "' TARGET=\"right_frame\" "
	else
...
function nodeImageSrc() {
  ...
  { 
    if (this.nChildren == 0)
      srcStr = ICONPATH + "last_leaf.png"
    else
      if (this.isOpen)
        srcStr = ICONPATH + "last_expanded.png"  
      else
        srcStr = ICONPATH + "last_closed.png"  
  } 
  else 
  { 
    if (this.nChildren == 0)
      srcStr = ICONPATH + "leaf.png"
    else
      if (this.isOpen)
        srcStr = ICONPATH + "expanded.png"
      else
        srcStr = ICONPATH + "closed.png"
  }   
  return srcStr;
}
...
function finalizeCreationOfItem(itemArray)
{
  ...
  itemArray.iconSrc = ICONPATH + "icon.png" 
...
{ 
  ...
  if (this.level>0) 
    ...
    { 
      leftSide = leftSide + "<td valign=top><img src='" + ICONPATH + "last_leaf.png' width=16 height=22></td>"
    } 
    else 
    { 
      leftSide = leftSide + "<td valign=top background=" + ICONPATH + "branch.png><img src='" + ICONPATH + "leaf.png' width=16 height=22></td>"
    } 
...
function leftSideHTML(leftSideCoded) {
	...
	for (i=0; i<leftSideCoded.length; i++)
	{
		...
		{
			retStr = retStr + "<td valign=top background=" + ICONPATH + "branch.png><img src='" + ICONPATH + "branch.png' width=16 height=22></td>"
		}
		if (leftSideCoded.charAt(i) == "0")
		{
			retStr = retStr + "<td valign=top><img src='" + ICONPATH + "blank.png' width=16 height=22></td>"
		}
	}
	return retStr
}
...
function preLoadIcons() {
	var auxImg
	auxImg = new Image();
	auxImg.src = ICONPATH + "branch.png";
	auxImg.src = ICONPATH + "last_expanded.png";
	auxImg.src = ICONPATH + "expanded.png";
	auxImg.src = ICONPATH + "last_closed.png";
	auxImg.src = ICONPATH + "closed.png";
	auxImg.src = ICONPATH + "blank.png";
	auxImg.src = ICONPATH + "last_leaf.png";
	auxImg.src = ICONPATH + "leaf.png";
	auxImg.src = ICONPATH + "closed_folder.png";
	auxImg.src = ICONPATH + "open_folder.png";
	auxImg.src = ICONPATH + "icon.png";
}
